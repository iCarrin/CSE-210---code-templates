class Flowering : Plant
{
    ...
    private string floweringTime;// { get; }
    ...
    : base(name, /*hardinessZone,*/ spacing, /*unLevel, soilType, perinial, frostTolerant, plantRotationFamily,sowAndPlant,*/ beneficiaries, benefactors, mutual)
    {
